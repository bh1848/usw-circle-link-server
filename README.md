...
<p align="center"><strong>동아리 모집·지원 관리 플랫폼</strong></p>
<p align="center">수원대학교 동아리연합회 공식 플랫폼</p>
...
백엔드 팀원으로 참여했으며, 인증/인가, 동아리·지원서·공지·Admin 기능, 파일 업로드 검증, 입력 정제, 공통 예외 처리 영역을 담당했습니다.  
